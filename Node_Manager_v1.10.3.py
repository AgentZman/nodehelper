...
#needs work here maybe add counter to disable alert if any are OFF etc. 
#stop alert loops but keep status loop etc.
    def monitor():
        alert_count=0
        while True:
            data=""
    ...
    for i, file_path in enumerate(found_files):
        ...
        checkbox[i] = tk.Checkbutton(window, text="Disable Alert", activebackground="goldenrod", bg=freedbg, variable=var, command=toggle_checkbox)
